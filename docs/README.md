...
## What is Corridor Key?

You can learn more about Corridor Key on their official [GitHub](https://github.com/nikopueringer/CorridorKey).

You can also watch these videos that explain all:
